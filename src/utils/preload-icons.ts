// Pre-load specific icons for @iconify/svelte to prevent CDN requests
// Only bundle the icons actually used in Svelte components
// Data can be obtained from https://icon-sets.iconify.design
